...
class BotEmbed(discord.Embed):
    def __init__(self, *, colour=BOT_EMBED_RGB, color=BOT_EMBED_RGB, title="TITLE", type='rich', url=None, description=None, timestamp=None):
        super().__init__(
            ...
            timestamp=timestamp)
        self.set_footer(text=f"[PUT NAME HERE] v{VERSION} by @matezzi75", icon_url="https://avatars.githubusercontent.com/u/146573782?s=400&u=a8b68f52dded16bbbb8b9dcce5004aff0a092b8c&v=4")